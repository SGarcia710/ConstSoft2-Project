                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input name="productName" type="text" class="form-control" required="" id="nameFive-first" placeholder="Nombre">
                      </div>

                      <div class="form-group">
                        <label for="emailFive" class="sr-only">Marca</label>
                        <input name="productBrand" type="text" class="form-control" required="" id="emailFive" placeholder="Marca">
                      </div>


                      <div class="form-group">
                        <label for="websiteOne" class="sr-only">Cantidad</label>
                        <input name="productQuantity" type="text" class="form-control" required="" id="websiteOne" placeholder="Cantidad">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group user-message">
                        <label for="messageOne" class="sr-only">Descripción</label>
                        <textarea name="productDescription" class="form-control" required="" id="messageOne" placeholder="Descripción"></textarea>
                      </div>
                    </div>
                  </div>
