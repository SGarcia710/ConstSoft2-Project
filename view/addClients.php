  ...
  <div id="main-wrapper">
    ...
    <div class="uc-mobile-menu-pusher">
      ...
      <div class="content-wrapper">
        ...
        <section class="single-page-title single-page-title-clientes">
        ...
        <section class="contact-form ptb-100">
          <div class="container text-center">
            <h2>Realiza el registro de los clientes<br>con el siguiente formulario.</h2>
            <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group user-name">
                        <label for="nameFive-first" class="sr-only">Nombres</label>
                        <input name="clientFirstName" type="text" class="form-control" required="" id="nameFive-first" placeholder="Nombres">
                      </div>
                      <div class="form-group user-name">
                        <label for="nameFive-first" class="sr-only">Apellidos</label>
                        <input name="clientLastName" type="text" class="form-control" required="" id="nameFive-first" placeholder="Apellidos">
                      </div>
                      <label for="sex" class="col-sm-2 control-label">Sexo</label>
                      <label class="radio-inline">
                        <input name="clientSex" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="Masculino"> Masculino
                      </label>
                      <label class="radio-inline">
                        <input name="clientSex" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="Femenino"> Femenino
                      </label>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="emailFive" class="sr-only">No. Identificación</label>
                        <input name="clientId" type="number" class="form-control" required="" id="emailFive" placeholder="No. Identificación">
                      </div>
                      <div class="form-group user-email">
                        <label for="emailFive" class="sr-only">Email</label>
                        <input name="clientEmail" type="email" class="form-control" required="" id="emailFive" placeholder="Correo Electrónico">
                      </div>
                      <div class="form-group user-phone">
                        <label for="websiteOne" class="sr-only">Celular</label>
                        <input name="clientPhone" type="text" class="form-control" required="" id="websiteOne" placeholder="Celular">
                      </div>
                    </div>
                  </div>
      ...
      <div>
        <div>
          <ul id="menu">
            ...
            <li><a href="products.php">Ver productos</a></li>
            <li><a href="addProducts.php">Agregar productos</a></li>
            <li class="active"><a href="clients.php">Ver clientes</a></li>
            <li><a href="addClients.php">Agregar Clientes</a></li>
          </ul>
        </div>
      </div>
